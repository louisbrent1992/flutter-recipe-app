                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          return Column(
                            children: [
                              ...
                              _buildAnimatedSwitchTile(
                                ...
                                subtitle:
                                    'Weekly Friday highlights at 12:00 PM',
                      ...
                      _buildAnimatedListTile(
                        ...
                        subtitle:
                            'Free up storage and fix image display issues',
                      ...
                      if (kDebugMode) ...[
                        ...
                        _buildAnimatedSwitchTile(
                          ...
                          subtitle:
                              'Show debug-only features like Refresh Image',
                        ...
                        if (_debugFeaturesEnabled) ...[
                          ...
                          _buildAnimatedListTile(
                            ...
                            onTap: () async {
                              final removed =
                                  await ImageResolverCache.clearAll();
                              if (context.mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
